...
Resultado del pusheado:
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{docker06.png}
\end{figure}
\FloatBarrier

Uso de la imagen pusheado en el \verb|docker.compose|:
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{docker07.png}
\end{figure}
\FloatBarrier

Despues de \verb|docker-compose up -d|, resultado en Docker Desktop:
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{docker08.png}
\end{figure}
\FloatBarrier
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{docker09.png}
\end{figure}
\FloatBarrier
...
Con este archivo \verb|yml| creado en \verb|.github/workflows| nos permite usar ese workflow manualmente desde el repositorio además de cuando se hace un push:
\begin{verbatim}
...
\subsection{Notificacion al pushear}

He intentado meterle notificación por email pero la cuenta alternativa de gmail que uso no me dejaba generar un App password, de manera que he usado los notificaciones nativas de Github.
...
La notificacion puede verse en el repositorio, la pestaña de Actions, clickeamos el último commit, click en notify-on-push.
